...
A GUI application to read the Quran with page-based navigation
"""
...
class QuranApp:
    def __init__(self, root):
        ...
        # Current state
        self.current_page = 1
        self.total_pages = 604  # Standard Quran has 604 pages
    ...
    def _setup_ui(self):
        ...
        # Canvas for page image with scrollbar
    ...
    def _load_page(self, page_num):
        ...
        if not image_path:
            ...
            for naming in [f"page_{page_num:03d}", f"page_{page_num}", f"A_intro_{page_num}"]:
                potential_path = self.assets_path / f"{naming}.png"
                if potential_path.exists():
                    image_path = potential_path
                    break
    ...
    def toggle_bookmark(self):
        ...
        if self.current_page in self.bookmarks:
            ...
            messagebox.showinfo("Bookmark Added", f"Page {self.current_page} added to bookmarks")
        
        self._save_bookmarks()
        self._load_page(self.current_page)  # Refresh to update bookmark indicator
